...
cmd = subprocess.Popen('which ipopt', stdout=subprocess.PIPE)
...
if chosen_objective == "Nonlinear":
    ...
    st.error("Curently, a nonlinear solver is not implemented yet! However, you can still play around with the visualization below while the nonlinear example is fully implemented 🥰")
